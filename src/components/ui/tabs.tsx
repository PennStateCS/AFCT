...
function TabsTrigger({ className, ...props }: React.ComponentProps<typeof TabsPrimitive.Trigger>) {
  return (
    <TabsPrimitive.Trigger
      ...
      className={cn(
        // The default segmented-control look. AFCT's application navigation does not use it
        // as-is: TabBar and TabRail both override the colours, and they are the only
        // consumers of this primitive in the app. What is left here is the four dark:
        // variants it used to carry (dark:text-muted-foreground, and an active state of
        // dark:border-input + dark:bg-input/30 + dark:text-foreground), which said in
        // theme variants what the tokens already say per theme, and which the two
        // overriding components then had to cancel. Semantic roles instead: quiet when
        // inactive, the card surface when active, in both themes.
        //
