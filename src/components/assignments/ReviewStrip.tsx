...
export function ReviewStrip({
  ...
  return (
      <div
        className={`flex flex-col divide-y rounded-md border xl:flex-row xl:items-stretch xl:divide-x xl:divide-y-0 xl:py-3 ${className}`}
      >
        ...
        <div className="flex min-w-0 items-center px-4 py-2 xl:flex-auto xl:py-0">
          <ProgressRing
            ...
            remainderTone={
              totals.count > 0 && totals.graded === totals.count
                ? 'danger'
                : 'muted'
            }
