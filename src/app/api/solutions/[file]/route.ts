...
export async function GET(req: NextRequest, { params }: { params: Promise<{ file: string }> }) {
  try {
    ...
    // Allow access if user is admin/faculty/ta, or if the user is enrolled in the course
    ...
    // Read file into buffer and return as response (simpler and compatible with Next's API)
