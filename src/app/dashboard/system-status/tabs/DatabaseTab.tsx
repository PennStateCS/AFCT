...
import { Skel, Stat, useStatusQuery, formatDbSize, formatDbVersion, copy } from '../status-ui';
  ...
  return (
    <div className="space-y-4">
      <div className="flex items-center justify-end gap-2">
        <span className="text-sm">Deep probes</span>
                ...
                {pg && (
                  <div>
                    ...
                    <div className="space-y-2">
                      ...
                      {pg.seq_scans != null && (
                        <Stat label="Sequential Scans" value={pg.seq_scans} />
                      )}
