...
export default function CalendarPage() {
  ...
  return (
    <div className="flex flex-col items-center justify-start min-h-screen overflow-hidden bg-background">
      ...
      <div className="w-full max-w-6xl border border-gray-200 rounded-lg shadow bg-card flex flex-col items-center p-4 flex-1" style={{ boxSizing: 'border-box', minHeight: 480 }}>
