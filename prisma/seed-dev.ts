 ...
 */
export const runDevelopmentSeed = async (prisma: PrismaClient): Promise<void> => {
  ...
  try {
    ...
    try {
      ...
      console.error('[seed] development: failed to create users', error);
      throw error;
    }
    ...
    try {
      ...
      console.error('[seed] development: failed to fetch created users', error);
      throw error;
    }

    if (createdUsers.length === 0) {
      throw new Error('[seed] development: no users were created; unable to proceed');
    }
    ...
    try {
      ...
      console.error('[seed] development: failed to upsert courses', error);
      throw error;
    }
    ...
    try {
      ...
      console.error('[seed] development: failed to assign rosters', error);
      throw error;
    }
    ...
    try {
      ...
      console.error('[seed] development: failed to log seed counts', error);
      throw error;
    }
  } catch (error: unknown) {
    console.error('[seed] development: seed failed', error);
    throw error;
  }
};
