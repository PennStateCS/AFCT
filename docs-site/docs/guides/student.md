...
AFCT shows your courses, assignments, submissions, grades, and comments. You cannot view another student's individual work or grades.

See [Roles and permissions](../reference/roles-and-permissions.md) for the full access model.
...
You can update your name, avatar, and timezone. Choose **Automatic** to follow the current device timezone, or select a fixed timezone to keep the display consistent.

Your account email address cannot be changed in AFCT. Contact an administrator if it is incorrect.

## Sign-in problems

Too many failed attempts temporarily lock an account. Wait for the lockout period to end or contact an administrator to reset your password. AFCT does not currently provide a manual unlock button.
