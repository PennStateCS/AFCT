...
Under the strength and the match type is the count that gives the match its meaning, for example "2 of 38 students submitted the same saved machine", along with the size of the work and how far apart the closest two submissions were.
